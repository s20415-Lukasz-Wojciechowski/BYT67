...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		return (this.currency==other.getCurrency()?
				new Money(this.amount+other.getAmount(),this.currency):
				new Money((int) (this.amount+other.universalValue().doubleValue()*this.currency.getRate().doubleValue()),this.currency));
	...
	public Money sub(Money other) {
		return other.getCurrency()==this.currency?
				new Money(this.amount-other.getAmount(),this.currency):
				new Money(this.amount-other.universalValue(),this.currency);
	}
